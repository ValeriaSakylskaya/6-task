...
public class BookService {
    ...
    private void viewBooksByIndex(int index) {
    ...
    public void changeBookDescription ( String description, int id){
    ...
    public void changeBookTitle ( String title, int id){
        books.get(id - 1).setName(title);
        saveBooks();

    }
    public void changeBookAuthor ( String author, int id){
